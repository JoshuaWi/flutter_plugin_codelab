...
class _MyAppState extends State<MyApp> {
  ...
  final _flutterPluginCodelabPlugin = FlutterPluginCodelab();
  ...
  Future<void> initPlatformState() async {
    ...
    try {
      platformVersion =
          await _flutterPluginCodelabPlugin.getPlatformVersion() ??
  ...
  void _onKeyDown(int key) {
    print("key down:$key");
    _flutterPluginCodelabPlugin.onKeyDown(key).then((value) => print(value));
  }

  void _onKeyUp(int key) {
    print("key up: $key");
    _flutterPluginCodelabPlugin.onKeyUp(key).then((value) => print(value));
  }
