...
class MockFlutterPluginCodelabPlatform
  ...
  @override
  Future<int?> onKeyDown(int key) => Future.value(42);

  @override
  Future<int?> onKeyUp(int key) => Future.value(42);
}

void main() {
  final FlutterPluginCodelabPlatform initialPlatform =
      FlutterPluginCodelabPlatform.instance;
  ...
  test('getPlatformVersion', () async {
    ...
    MockFlutterPluginCodelabPlatform fakePlatform =
        MockFlutterPluginCodelabPlatform();
